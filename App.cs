...
namespace planetlogs
{
  class App
  {
    ...
    public void Startup()
    {
      ...
      Planet planet9 = new Planet("Planet9");
      ...
      //   mercury.AddLocation("previous", sun);
      //   make the sun with a timeout that incinerates visitor after 5 seconds
      ...
      jupiter.AddLocation("next", saturn);
      saturn.AddLocation("previous", jupiter);
      saturn.AddLocation("next", uranus);
      uranus.AddLocation("previous", saturn);
      uranus.AddLocation("next", neptune);
      neptune.AddLocation("previous", uranus);
      neptune.AddLocation("next", pluto);
      pluto.AddLocation("previous", neptune);
      pluto.AddLocation("next", planet9);
      planet9.AddLocation("previous", pluto);
      // planet9.AddLocation("next", jupiter);  * Make this go into a blackhole after 5 seconds
      //Set Active Planet
